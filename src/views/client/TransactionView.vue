<template>
  <div id="transaction">
    <div class="transaction-container">
      ...
      <img v-if="dataReady && isSuccess" src="@/assets/images/icon/success.png" />
      <img v-if="dataReady && !isSuccess" src="@/assets/images/icon/error.png" />
      ...
      <p v-if="!dataReady">
        Giao dịch của bạn đang được hệ thống sử lý. Vui lòng đợi trong giây lát.
      </p>
      <p v-if="dataReady && isSuccess">
        Giao dịch của bạn đã hoàn tất. Vui lòng kiểm tra lại số dư tài khoản.
      </p>
      <p v-if="dataReady && !isSuccess">Có lỗi xảy ra. Vui lòng thử lại sau.</p>
      <div class="btn-group">
        <router-link to="/">
