...
export default {
  ...
  methods: {
    ...
    setupData() {
      ...
      if (this.post.type) this.info.type = this.post.type;
      ...
      if (this.post.expired_at) this.info.expired_at = this.dateTimeFormatter(this.post.expired_at);
    ...
    createFormData() {
      ...
      if (this.info.expired_at) obj.append('expired_at', this.info.expired_at);
      if (this.info.type) obj.append('type', this.info.type);
